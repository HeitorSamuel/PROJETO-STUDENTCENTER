...
.then(() => {
    console.log("Conexão com o banco de dados 'cadastroprof' realizada com sucesso!");
})
.catch((err) => {
    console.error("ERRO: Conexão com o banco de dados 'cadastroprof' não realizada com sucesso!", err);
});
